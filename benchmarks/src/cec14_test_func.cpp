...
double *OShift_14 = nullptr;
double *M_14 = nullptr;
double *y_14 = nullptr;
double *z_14 = nullptr;
double *x_bound_14 = nullptr;
int *SS_14 = nullptr;
int ini_flag_14 = 0;
int n_flag_14 = 0;
int func_flag_14 = 0;
...
// Use renamed globals to avoid conflicts with other CEC files
#define OShift OShift_14
#define M M_14
#define y y_14
#define z z_14
#define x_bound x_bound_14
#define SS SS_14
#define ini_flag ini_flag_14
#define n_flag n_flag_14
#define func_flag func_flag_14
...
void cec14_test_func(double *x, double *f, int nx, int mx,int func_num)
{
	...
	if (ini_flag==0)
	{
		...
		/* Load Matrix M*/
		sprintf(FileName, "%s/M_%d_D%d.txt", CEC14_DATA_DIR, func_num,nx);
		...
		/* Load shift_data */
		sprintf(FileName, "%s/shift_data_%d.txt", CEC14_DATA_DIR, func_num);
		fpt = fopen(FileName,"r");
		if (fpt==NULL)
		{
			printf("\n Error: Cannot open input file for reading: %s\n", FileName);
		...
		{
			sprintf(FileName, "%s/shuffle_data_%d_D%d.txt", CEC14_DATA_DIR, func_num, nx);
			fpt = fopen(FileName,"r");
			if (fpt==NULL)
			{
				printf("\n Error: Cannot open input file for reading: %s\n", FileName);
